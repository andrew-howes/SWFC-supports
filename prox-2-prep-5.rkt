...
(print "Ambush 3, Prep skill up 5, HP 3")
(newline)
(find-sets proximity-2 prep-5 hp-3)
(newline)(newline)

(print "Ambush 3, Prep skill up 5, HP 4")
(newline)
(find-sets proximity-2 prep-5 hp-4)
(newline)(newline)

(print "Ambush 3, Prep skill up 5, HP 5")
(newline)
